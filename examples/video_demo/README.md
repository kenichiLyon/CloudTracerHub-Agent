...
- 统一 mock 配置：[`examples/video_demo/lubster.video.config.json`](./lubster.video.config.json)
- 场景 1：[`examples/video_demo/incidents/01_course_selection_timeout.json`](./incidents/01_course_selection_timeout.json)
- 场景 2：[`examples/video_demo/incidents/02_gov_service_signature_failure.json`](./incidents/02_gov_service_signature_failure.json)
- 场景 3：[`examples/video_demo/incidents/03_grade_query_backlog.json`](./incidents/03_grade_query_backlog.json)
...
- 录命令行时建议使用 `--format pretty`，分层结构更清楚
